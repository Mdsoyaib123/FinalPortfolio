  ...
  const skills = [
    {
      ...
      skills: [
        ...
        
        {
          name: "Typescript",
          image:
            "https://cdn3d.iconscout.com/3d/free/thumb/free-typescript-3d-icon-download-in-png-blend-fbx-gltf-file-formats--microsoft-logo-angular-language-javascript-static-type-coding-lang-pack-logos-icons-7577992.png",
        },
        {
          name: "JavaScript",
          image:
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          name: "Mongoose",
          image:
            "https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-thumbnail/s3/102012/mongoose.jpg?itok=_F5X8WNg",
        },
        {
          name: "Firebase",
        ...
        {
          name: "Jwt",
          image: "https://i.ibb.co/dBJCQTL/icons8-jwt.png",
        },
      ],
    },
    {
      ...
      skills: [
        {
          name: "Git",
          image:
            "https://i.postimg.cc/RVhkTtnm/kisspng-github-repository-git-project-commit-5b0f2dd1efb513-5784673515277214259819.jpg",
        },
        {
          name: "GitHub",
          image:
        ...
        },
        {
          name: "Postman",
          image:
            "https://i.postimg.cc/Kzg62hxY/571-5718602-transparent-ubuntu-logo-png-logo-postman-icon-png.png",
        },

        {
          name: "Figma",
          image: "https://i.postimg.cc/DyYPqJ1t/figma-1-logo.png",
        },
      ],
    },
  ];
            ...
            >
              ...
              <ul className="flex flex-wrap justify-center gap-4">
                {skill.skills.map((item) => (
                  <li
                    key={item.name}
                    className="flex items-center gap-2 bg-gray-900/70 px-4 py-2 rounded-md text-sm hover:scale-105 transition-transform duration-200 border border-gray-700"
                  >
