              ...
              <div className="md:w-1/2 mt-7 md:mt-0 ">
                <ul className="mb-6">
                  ...
                  <li className="flex items-center gap-2 mb-4">
                    ...
                    Here , implement firebase authentication system for Login
                    and Register and use Jwt token.
                  </li>
                  <li className="flex items-center gap-2 mb-4">
                    <span>
                      <svg
                    ...
                    User can add a product in his cart and he can delete the the
                    product .
                  </li>
                  <li className="flex items-center gap-2 mb-4">
                    <span>
                ...
                <div className="flex gap-5 flex-wrap mb-6 md:mb-0">
                  <a
                    href="https://astounding-meringue-48e9f7.netlify.app"
                    target="_blank"
                  >
                    <button className="border border-blue-500 hover:bg-blue-500 shadow-2xl px-4 py-2 rounded-md text-sm">
                      Live link
                  ...
                  <a
                    href="https://github.com/Mdsoyaib123/The-Brand-Shop"
                    target="_blank"
                  >
                    <button className="border  border-blue-500 hover:bg-blue-500 shadow-2xl px-4 py-2 rounded-md text-sm">
                      Client code
                  ...
                  <a
                    href="https://github.com/Mdsoyaib123/The-Brand-Shop-Server"
                    target="_blank"
                  >
                    <button className="border  border-blue-500 hover:bg-blue-500  px-4 py-2 rounded-md text-sm md:text-base">
                      Server code{" "}
